  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to load historical scenarios'
      );
    }
  }
);
...
>(
  ...
  async (request, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to load historical context'
      );
    }
  }
);
...
>(
  ...
  async ({ request, cacheKey }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to find historical analogies'
      );
    }
  }
);
...
>(
  ...
  async ({ request, cacheKey }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to calculate similarity score'
      );
    }
  }
);
...
>(
  ...
  async (request, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to add historical scenario'
      );
    }
  }
);
...
>(
  ...
  async (key, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(
        error instanceof Error ? error.message : 'Failed to delete historical scenario'
      );
    }
  }
);
