...
const files = [
  ...
  // Компоненты: layout
  'src/components/layout/PageContainer/Header.tsx',
  'src/components/layout/PageContainer/Sidebar.module.css',
  'src/components/layout/Sidebar/Header.tsx',
  'src/components/layout/Sidebar/Sidebar.module.css',
  'src/components/layout/Header/Header.tsx',
  'src/components/layout/Header/Sidebar.module.css',
  'src/components/layout/Footer/Header.tsx',
  'src/components/layout/Footer/Sidebar.module.css',
  ...
  'src/pages/Dashboard/Sidebar.module.css',
  'src/pages/PortfolioCreation/Header.tsx',
  'src/pages/PortfolioCreation/Sidebar.module.css',
  'src/pages/PortfolioAnalysis/Header.tsx',
  'src/pages/PortfolioAnalysis/Sidebar.module.css',
  'src/pages/PortfolioOptimization/Header.tsx',
  'src/pages/PortfolioOptimization/Sidebar.module.css',
  'src/pages/RiskManagement/Header.tsx',
  'src/pages/RiskManagement/Sidebar.module.css',
  'src/pages/ScenarioAnalysis/Header.tsx',
  'src/pages/ScenarioAnalysis/Sidebar.module.css',
  'src/pages/HistoricalAnalogies/Header.tsx',
  'src/pages/HistoricalAnalogies/Sidebar.module.css',
  'src/pages/PortfolioComparison/Header.tsx',
  'src/pages/PortfolioComparison/Sidebar.module.css',
  'src/pages/ReportGeneration/Header.tsx',
  'src/pages/ReportGeneration/Sidebar.module.css',
];
